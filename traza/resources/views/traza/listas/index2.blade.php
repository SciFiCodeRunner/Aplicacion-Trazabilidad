@extends ('layouts.admin')
	...
	<div class="row">
		<div class= "col-lg-8 col-md-8 col-sm-8 col-xs-12">
			...
			<h3>Detalle Abscisa </h3> <a href="http://localhost:8000/traza/abscisas"><button class="btn btn-success">Retornar</button></a>
		</div>
	</div>
	<div class= "row">
						...
						<tr style="text-align:center">
							...
							<td >{{($abs->volumenExcavado-$abs->volumen_excavado_obra)}}</td>
								...
								<tr style="text-align:center">
									...
									<td colspan="2">{{$abs->volumen_llenado_teorico}} {{'M3'}}</td>
