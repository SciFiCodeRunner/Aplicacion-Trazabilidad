...
<h4 align="center"><font color="red">
	...
	<table class= "table table-striped table-bordered table-condensed table-hover ">
		...
		<tr style="text-align:center">
			...
			<td ><?php echo e(round($Terraplen/1.3-$abs->volumen_excavado_obra,2)); ?> mᶟ</td>
			<td ><?php echo e(round($Comun/1.3-$abs->volumen_llenado_obra,2)); ?> mᶟ</td>
		</tr>
		<TR>
		...
		<tr style="text-align:center">
			...
			<td colspan="2"><?php echo e(0); ?>  </td>
			<?php elseif($Terraplen/$abs->volumen_excavado_teorico>1.35||$Terraplen/$abs->volumen_excavado_teorico < 1.25): ?>
			<td id="color1" colspan="2"><?php echo e(round($Terraplen/$abs->volumen_excavado_teorico,2)); ?> </td>
			<?php else: ?>
			<td colspan="2"><?php echo e(round($Terraplen/$abs->volumen_excavado_teorico,2)); ?>  </td>
			<?php endif; ?>
			...
			<td id="color1" colspan="2"><?php echo e(round($Comun/$abs->volumen_llenado_teorico,2)); ?> </td>
			<?php else: ?>
			<td colspan="2"><?php echo e(round($Comun/$abs->volumen_llenado_teorico,2)); ?> </td>
			<?php endif; ?>


			<!--coeficiente/real corte-->

			<?php if($Terraplen==0||$abs->volumen_excavado_obra==0||$abs->volumen_excavado_obra==0.0||$Terraplen==0.00||$Terraplen==0.0): ?>
			<td colspan="2"><?php echo e(0); ?>  </td>
			<?php else: ?>
			<td colspan="2"><?php echo e(round($Terraplen/$abs->volumen_excavado_obra,2)); ?> </td>
			<?php endif; ?>


			<!--coeficienteRealLLeno-->
			<?php if($Comun==0||$abs->volumen_llenado_obra==0||$abs->volumen_llenado_obra==0.0||$abs->volumen_llenado_obra==0.00||$Comun==0.00||$Comun==0.0): ?>
			<td colspan="2"><?php echo e(0); ?> </td>
			<?php else: ?>
			<td colspan="2"><?php echo e(round($Comun/$abs->volumen_llenado_obra,2)); ?>  </td>
			<?php endif; ?>
