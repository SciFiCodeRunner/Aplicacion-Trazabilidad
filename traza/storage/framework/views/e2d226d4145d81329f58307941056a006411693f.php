...
<div class="row">
	<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
		<h3>
			Editar Transporte  :<?php echo e($vehiculo->numeroRecibo); ?></h3>
			...
			<?php echo Form::model($vehiculo,['method'=>'PATCH','action'=>['VehiculoTransporteController@update',$vehiculo->idVehiculo]]); ?>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="numeroRecibo" class="form-control" placeholder="Placa..." value="<?php echo e($vehiculo->numeroRecibo); ?>">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<textarea class="form-control" rows="2" name="observaciones" placeholder="Observaciones..." value="<?php echo e($vehiculo->observaciones); ?>"></textarea>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="form-group">
						...
						<select name="id_abscisa_descargue" class="form-control">
							<?php $__currentLoopData = $abscisas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abs2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($abs2->idAbscisa); ?>"> <?php echo e($abs->nombre); ?>
