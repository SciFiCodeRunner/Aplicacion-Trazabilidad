...
<div class="row">
	<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
		<h3>
			Editar Transporte  :<?php echo e($vehiculo->idMaterial); ?></h3>
			...
			<?php echo Form::model($vehiculo,['method'=>'PATCH','action'=>['VehiculoTransporteController@update',$vehiculo->numeroRecibo]]); ?>
