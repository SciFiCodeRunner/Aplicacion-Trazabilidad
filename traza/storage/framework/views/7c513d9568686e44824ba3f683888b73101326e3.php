			...
			<h4 align="center"><font color="red">
				...
				<table class= "table table-striped table-bordered table-condensed table-hover">
					...
					<tr style="text-align:center">
						...
						<!--volumen teorico-->
						<td><?php echo e($abs->volumen_llenado_teorico); ?> 
							mᶟ </td>
							<td><?php echo e($abs->volumen_excavado_teorico); ?> 
								mᶟ </td>
								<!--volumen transportado-->
								<td><?php echo e($abs->volumenLlenado); ?> 
									mᶟ </td>
									<td><?php echo e($abs->volumenExcavado); ?> 
										mᶟ  </td>
										...
										<!--volumen en obra-->
										<td><?php echo e($abs->volumen_llenado_obra); ?> 
											mᶟ </td>
											<td><?php echo e($abs->volumen_excavado_obra); ?> 
												mᶟ </td>
											...
											<tr style="text-align:center">
												...
												<td colspan="2"><?php echo e($abs->volumen_llenado_teorico); ?> 
													mᶟ </td>
													<?php elseif($abs->volumenLlenado/$abs->volumen_llenado_teorico>=1.25||$abs->volumenLlenado/$abs->volumen_llenado_teorico <= 1.35): ?>
													<td id="color1" colspan="2"><?php echo e(round($abs->volumenLlenado/$abs->volumen_llenado_teorico,2)); ?> 
														mᶟ </td>
														<?php else: ?>
														<td colspan="2"><?php echo e(round($abs->volumenLlenado/$abs->volumen_llenado_teorico,2)); ?> 
															mᶟ </td>
															<?php endif; ?>
															...
															<td colspan="2"><?php echo e($abs->volumen_excavado_teorico); ?> 
																mᶟ </td>
																<?php elseif($abs->volumenExcavado/$abs->volumen_excavado_teorico>1.35||$abs->volumenExcavado/$abs->volumen_excavado_teorico < 1.25): ?>
																<td id="color1" colspan="2"><?php echo e(round($abs->volumenExcavado/$abs->volumen_excavado_teorico,2)); ?> 
																	mᶟ </td>
																	<?php else: ?>
																	<td colspan="2"><?php echo e(round($abs->volumenExcavado/$abs->volumen_excavado_teorico,2)); ?> 
																		mᶟ </td>
																		<?php endif; ?>
																		...
																		<td colspan="2"><?php echo e($abs->volumen_excavado_obra); ?> 
																			mᶟ </td>
																			<?php else: ?>
																			<td colspan="2"><?php echo e(round($abs->volumen_excavado_obra/$abs->volumenExcavado,2)); ?> 
																				mᶟ </td>
																				<?php endif; ?>
																				...
																				<td colspan="2"><?php echo e($abs->volumen_llenado_obra); ?> 
																					mᶟ </td>
																					<?php else: ?>
																					<td colspan="2"><?php echo e(round($abs->volumen_llenado_obra/$abs->volumenLlenado,2)); ?> 
																						mᶟ </td>
																						<?php endif; ?>
