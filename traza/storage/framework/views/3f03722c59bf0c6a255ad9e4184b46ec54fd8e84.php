          ...
          <ul class="sidebar-menu">
            <li class="header"></li>
              ...
              <ul class=" treeview active-menu">
                <li><a href="<?php echo e(url('traza/listas')); ?>"><i class="fa fa-circle-o "></i>Coches</a></li>
            ...
            <li class="treeview active">
              ...
              <ul class=" treeview-menu">
                ...
                <li><a href="<?php echo e(url('traza/vehiculos')); ?>"><i class="fa fa-circle-o"></i>Coches de carga</a> <li><a href="<?php echo e(url('traza/vehiculosTransporte')); ?>"><i class="fa fa-circle-o"></i>Transporte en obra</a>
                </li>
              </ul>
            </li>
            <li class=" treeview active">
