			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" value="0" name="volumen_llenado_teorico" class="form-control" placeholder="Volumen llenado teorico...">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="volumen_excavado_teorico" value="0" class="form-control" placeholder="Volumen corte  teorico...">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="volumen_llenado_obra" value="0" class="form-control" placeholder="volumen llenado/obra...">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="volumen_excavado_obra" value="0" class="form-control" placeholder="volumen exc/obra...">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="coef_real_llenado" value="0" class="form-control" placeholder="coef/real llenado...">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="coef_real_excavado"  value="0" class="form-control" placeholder="coef/real exc ...">
