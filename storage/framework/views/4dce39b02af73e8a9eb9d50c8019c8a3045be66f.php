...
<div class="row">
	<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
		<h3>
			Editar Vehiculo Con Placa  :<?php echo e($vehiculo->placa); ?></h3>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="costo_acarreo" class="form-control" 	value="<?php echo e($vehiculo->costo_acarreo); ?>" 
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="volumen_carga" class="form-control" 	value="<?php echo e($vehiculo->volumen_carga); ?>" 
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="cantidad_viajes" class="form-control" 	value="<?php echo e($vehiculo->cantidad_viajes); ?>" 
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="volumen_transportado" 
							value="<?php echo e($vehiculo->volumen_transportado); ?>" 
