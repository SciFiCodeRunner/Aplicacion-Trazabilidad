...
--
-- Servidor: localhost
-- Tiempo de generación: 08-05-2017 a las 04:39:07
...
('500m al lado del rio', 1, 'k0+100', '20', '10', 1, '22.00', '15.00'),
('presenta mucha piedra caliza', 2, 'k0+200', '35', '40', 1, '37.00', '42.00');
...
('LYJ98A', 7, '2', '45', '78500', 1, 1, 13, 0),
('kmx834', 98, '5', '0', '0', 1, 3, 1, 0),
('mnu988', 67, '55', '58', '900000', 1, 5, 7, 0),
...
('2017-04-12', 1, 'llego bien', 1, 1, 1, 2, '100'),
('2017-04-12', 2, 'ttt', 3, 2, 2, 1, '20'),
('2017-04-12', 3, 'good', 1, 3, 1, 2, '50'),
('2017-04-15', 45, 'bien', 10, 3, 1, 2, '200'),
('2017-04-14', 87, 'todo bien ', 22, 4, 1, 2, '100');
...
--
ALTER TABLE `abscisas`
  MODIFY `idAbscisa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
